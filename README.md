...
#### 🧠 [DocuMind Pro - Enterprise Agentic RAG]
...
* **Pipeline:** Implements an Agent Router to dynamically seamlessly shift between semantic PDF search, live DuckDuckGo web scraping, and computer vision analysis (chart/image interpretation).
...
#### 📈 [WallStreet LLM - Domain-Specific Fine-Tuning & ReAct Agent]
